		...
		<form action="login.lti" method="post" id="loginmain">
			...
			<div class="input-container">
				<i class="fa fa-envelope icon" aria-hidden="true"
					style="width: 10%; float: left;"></i> <input type="email"
					name="email" placeholder="Email" required="email"
					style="width: 89%; float: left;" />
			</div>
			<div class="input-container">
				<i class="fa fa-lock icon" aria-hidden="true"
					style="width: 10%; float: left;"></i> <input type="password"
					name="password" placeholder="Password" required="password"
					style="width: 89%; float: left;" />
			...
			<div>
				<p class="text-p" style="float: right">
					<a href="#">Forgot password?</a>
				</p>
			</div>
		</form>

		<form action="register.lti" name="signupForm" method="post"
			id="signupmain" onSubmit="return validate()">
			<div class="title">Sign Up</div>
			<div class="input-container">
				<i class="fa fa-user icon" aria-hidden="true"
					style="width: 10%; float: left;"></i> <input type="text" id="user"
					placeholder="Username" style="width: 89%; float: left;" />
				<p id="name" class="error"></p>
			</div>


			<div class="input-container">
				<i class="fa fa-mobile icon" aria-hidden="true"
					style="width: 10%; float: left;"></i> <input type="text"
			...
			<div class="input-container">
				<i class="fa fa-envelope icon" aria-hidden="true"
					style="width: 10%; float: left;"></i> <input type="email"
					id="email" placeholder="Email" style="width: 89%; float: left;"
					required />
			...
			<div class="input-container">
				<i class="fa fa-lock icon" aria-hidden="true"
					...
					style="width: 89%; float: left;" required />
